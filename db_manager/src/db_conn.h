...
public:
	...
	virtual bool update(const char* table, const char* fields, const char* query) = 0;
	virtual bool query(const char* table, const char* fields, const char* query, char* result, int& len) = 0;
};
